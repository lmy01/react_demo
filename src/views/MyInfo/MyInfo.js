  ...
  constructor(props) {
    ...
    this.state = {
      ...
      info: {
        ...
        introduce: '有极思想成熟、有活力、为人诚实。强的系统管理能力。能够独立工作。需要有能力及适应力强的人。需要个性稳重、具高度责任感的人。开朗、有进取心的应聘者。思想成熟、有活力、为人诚实。有极强的系统管理能力。能够独立工作。需要有能力及适应力强的人。需要个性稳重、具高度责任感的人。开朗、有进取心的应聘者。'
      },
      tagList: [],
      addTageInputValue: '',
    }
